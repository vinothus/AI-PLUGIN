...
exports.extractFocusChain = exports.compactConversation = exports.continueTask = exports.summarizeTask = void 0;
const summarizeTask = (focusChainEnabled) => `<explicit_instructions type="summarize_task">
...
const continueTask = (summary, focusChainEnabled) => `<explicit_instructions type="continue_task">
...
const compactConversation = (focusChainEnabled) => `<explicit_instructions type="compact_conversation">
...
const extractFocusChain = () => `<explicit_instructions type="extract_focus_chain">
...
exports.extractFocusChain = extractFocusChain;
