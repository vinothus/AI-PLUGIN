...
exports.SYSTEM_PROMPT_COMPACT = void 0;
const os = __importStar(require("os"));
const SYSTEM_PROMPT_COMPACT = async (context) => {
    const cwd = context.cwd;
    const shell = process.env.SHELL || 'bash';
    return `**ENTERPRISE AI PLUGIN — Identity & Mission**
...
${context.mcpServers.length > 0
        ? `MCP Servers: ${context.mcpServers.join(', ')}`
        : ""}
...
exports.SYSTEM_PROMPT_COMPACT = SYSTEM_PROMPT_COMPACT;
